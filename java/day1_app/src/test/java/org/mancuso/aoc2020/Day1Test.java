...
public class Day1Test {
	...
	public void testSmall() {
		Day1 day1 = new Day1();
		NTuple<Integer> result=null;
		try {
			List<Integer> data = day1.load("small");
			assertArrayEquals(new Integer[] { 1721, 979, 366, 299, 675, 1456 }, data.toArray(new Integer[] {}));
			result = day1.find(2, 2020, data);
		} catch (IOException iox) {
			fail("Unable to load file for  small: " + Paths.get("small").toAbsolutePath());
		}
